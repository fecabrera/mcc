...
| Module                                 | Import                     | Provides                                                                                                                                                                                                                                                                                  |
| -------------------------------------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [list.mc](list.mc)                     | `import "list";`           | Growable generic `list<T>`: `list_init`/`list_destroy`/`list_reset`, `list_get`/`list_set`, `list_push` (one element; doubles when full), `list_append` (concatenate another list), and `list_it`/`list_next` iteration.                                                                  |
...
| [string.mc](string.mc)                 | `import "string";`         | Growable byte string `string` (a `type string = list<uint8>`): `string_init`/`string_duplicate`/`string_destroy`/`string_reset`, `string_get`/`string_set`, `string_push` (one byte), `string_append` (concatenate another string), `string_eq`, and `string_it`/`string_next` iteration. |
