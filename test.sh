...
run_echo "$VENV/bin/mcc" hi.mc -Werror -Wextern-nonnull --run   # JIT: codegen + the bundled stdlib
run_echo "$VENV/bin/mcc" hi.mc -Werror -Wextern-nonnull -o hi   # native: object emission and linking
run_echo ./hi
