...
fn main() -> int32 {
    ...
    with (f = a as float64) {
        let doubled = f * 2.0;
        println("float64 doubled: %f", doubled);
    }
    ...
    with (n = empty as int32) println("int32: %d", n);
    ...
    println("pointee_width(&origin) = %d", pointee_width(&origin));
    println("pointee_width(\"hi\")    = %d", pointee_width("hi"));
    println("pointee_width(42)      = %d", pointee_width(42));

    // The generic value pattern: T binds to each boxed type in turn.
    println("payload_width(42)      = %d", payload_width(42));
    println("payload_width(2.5)     = %d", payload_width(2.5));
    println("payload_width(false)   = %d", payload_width(false));
