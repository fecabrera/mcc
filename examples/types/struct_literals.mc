...
fn main() -> int32 {
    ...
    println("segment ({},{}) -> ({},{})", seg.from.x, seg.from.y, seg.to.x, seg.to.y);
    ...
    println("config: capacity={} verbose={} name={}", cfg.capacity, cfg.verbose, cfg.name);
    ...
    println("default config: capacity={} verbose={}", dfl.capacity, dfl.verbose);
    ...
    *h = point { x = 10, y = 20 };
    ...
    println("bare assign = ({}, {})", bp.x, bp.y);
    println("length2 = {}", length2({ x = 6, y = 8 }));  // argument
    let s = shifted({ x = 0, y = 0 });                   // argument + bare return
    println("shifted = ({}, {})", s.x, s.y);
    let seg2: struct line = { from = { x = 1, y = 2 }, to = { x = 3, y = 4 } };
    println("bare segment ({},{}) -> ({},{})",
